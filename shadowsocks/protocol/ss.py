...
class SSProtocol(Protocol):
    ...
    def parse_header(self, data):
        ...
        if addrtype == ADDRTYPE_IPV4:
            if len(data) >= 7:
                ...
                raise ProtocolParseError('ss header is too short %s' % len(data))
            ...
            raise ProtocolParseError('ss unsupported addrtype %d, maybe wrong password' % addrtype)
    ...
    def unpack_udp(self, data, address):
        ...
        if addr_type == 1:
            ...
            raise ProtocolParseError("ss udp unknown addr_type %s" % addr_type)
