...
class Sock5Protocol(Protocol):
    ...
    def handle_cmd(self, data):
        ...
        if cmd == 0x03:
            ...
            return 2
        self.request.end()
        raise ProtocolParseError("sock5 unknown cmd %s" % cmd)
    ...
    def parse_addr_info(self,data):
        ...
        if addr_type == 1:
            ...
            raise ProtocolParseError("sock5 unknown addr_type %s" % addr_type)
    ...
    def unpack_udp(self, data, address):
        ...
        if addr_type == 1:
            ...
            raise ProtocolParseError("sock5 udp unknown addr_type %s" % addr_type)
